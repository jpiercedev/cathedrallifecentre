...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: new URL("/groups", siteConfig.productionUrl).toString(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: new URL("/classes", siteConfig.productionUrl).toString(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: new URL("/volunteer", siteConfig.productionUrl).toString(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
